...
public final class PGResult: @unchecked Sendable {
	...
	public func errorMessage() -> String {
		...
		return String(validatingCString: PQresultErrorMessage(res)) ?? ""
	}
	...
	public func fieldName(index: Int) -> String? {
		guard let res = self.res,
			...
			let ret = String(validatingCString: fn) else {
				return nil
		}
		return ret
	}
	...
	public func getFieldString(tupleIndex: Int, fieldIndex: Int) -> String? {
		...
		return String(validatingCString: v)
	}
...
public final class PGConnection: @unchecked Sendable {
	...
	public func errorMessage() -> String {
		return String(validatingCString: PQerrorMessage(conn)) ?? ""
	}
	...
	public typealias ReceiverProc = @Sendable (PGResult) -> Void

	/// Handler for processing a text message
	public typealias ProcessorProc = @Sendable (String) -> Void
